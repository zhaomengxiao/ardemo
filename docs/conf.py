...
# -*- coding: utf-8 -*-
#
# ardemo documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under ardemo
...
project = u'ARDemo'
copyright = u"2023, Zhao Youjun"
author = u'Zhao Youjun'
...
# The short X.Y version.
# version = ardemo.__version__
# The full version, including alpha/beta/rc tags.
# release = ardemo.__version__
...
latex_documents = [
    ('index', 'ardemo.tex',
     u'ARDemo Documentation',
     u'Zhao Youjun', 'manual'),
]
